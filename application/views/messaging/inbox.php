                        ...
                        <a data-contact class="lv-item media" href="#<?php echo $msisdn; ?>" data-msisdn="<?php echo $msisdn; ?>">
                            ...
                            <div class="media-body">
                                <?php foreach ($contacts_arr as $contact) { ?>
                                    <div class="lv-title contact-name <?php echo $contact->status ? 'unread' : ''; ?>"><?php echo !empty($contact->fullname) ? $contact->fullname : $msisdn; ?></div>

                                    <!-- Status -->
                                    <?php if ($contact->status): ?>
                                    <div data-message-unread class="notification-circle unread"><?php echo $contact->status; ?></div>
                                    <?php endif; ?>
                                    <!-- /Status -->
