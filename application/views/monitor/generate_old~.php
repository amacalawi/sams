                            ...
                            <tbody>
                                <thead>
                                    ...
                                    ?>
                                        ...
                                        <?php
                                            $has_time_in = $this->Monitor->get_dtrlog_in($row->stud_no, date("Y-m-d", $i), date("H:i:s", $time_from), date("H:i:s", $time_to));
                                            $has_time_out = $this->Monitor->get_dtrlog_out($row->stud_no,date("Y-m-d", $i),date("H:i:s", $time_from),date("H:i:s", $time_to));
                                        ?>
                                        ...
                                        <tr class="tborder">
                                            ...
                                            <td width="20%" class="<?php echo ($inc%2 == 0) ? 'bgm-green-2' : '' ?>">
                                                <h5>
                                                    <strong class="<?php echo ($inc%2 == 0) ? 'c-black' : '' ?>">
                                                        <?php echo $in = $this->Monitor->get_dtrlog_in($row->stud_no, date("Y-m-d", $i), date("H:i:s", $time_from), date("H:i:s", $time_to)); ?>
                                                    </strong>
                                            ...
                                            <td width="20%" class="<?php echo ($inc%2 == 0) ? 'bgm-green-2' : '' ?>">
                                                <h5>
                                                    <strong class="<?php echo ($inc%2 == 0) ? 'c-black' : '' ?>">
                                                        <?php echo $out = $this->Monitor->get_dtrlog_out($row->stud_no,date("Y-m-d", $i),date("H:i:s", $time_from),date("H:i:s", $time_to)); ?>
                                                    </strong>
                                                </h5>
                                            </td>
                        ...
                        <table class="table i-table m-t-25 m-b-25">
                            <tbody>
                                <?php
                                    ...
                                    foreach ($results as $row) {
                                ?>  
                                    <?php if($_GET['category'] == 'Level' || $_GET['category'] == 'Group') { ?>
                                        <?php if(!isset($inc) || $inc == 0) {  $inc = 0; ?>
                                            <tr class="tborder">
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php foreach ($level['result'] as $row1) { $inc++ ?>
                                            <tr class="tborder">
