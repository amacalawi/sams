<section id="content">
    <div class="container">
        ...
        <div class="toolbar-group text-right">
            <a href="<?php echo base_url('messaging/templates'); ?>" class="btn btn-danger btn-link toolbar-item"><i class="fa fa-arrow-left">&nbsp;</i>Go Back</a>
        </div>

        <div class="card">
            <?php echo breadcrumbs('', 'All Trashed Templates'); ?>
