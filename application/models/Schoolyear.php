...
class Schoolyear extends CI_Model
{
    ...
    public $validations = array(
        ...
        // array( 'field' => 'code', 'label' => 'Name', 'rules' => 'required|trim' ),
        array( 'field' => 'year_start', 'label' => 'Start Year', 'rules' => 'required|numeric|trim' ),
        array( 'field' => 'year_end', 'label' => 'End Year', 'rules' => 'required|numeric|trim' ),
        array( 'field' => 'status', 'label' => 'Status', 'rules' => 'required|trim' ),
    );
    ...
    public function validate($is_first_time=false, $id=null, $value=null)
    {
        ...
        if( $is_first_time ) {
            ...
            $ss = $this->db->where($this->column_id, $id)->get($this->table)->row();
            $original = $ss->code;
