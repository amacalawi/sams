...
class Gate extends CI_Model {
    ...
    public $validate = array(
        array( 'field' => 'name', 'label' => 'Gate Name', 'rules' => 'required|trim' ),
    ...
    public function validate($is_first_time=false, $id=null, $value=null)
    {
        ...
        if($is_first_time)
        {
            ...
            $this->form_validation->set_rules( 'code', 'Code', 'is_unique[gates.code]' );
        }
        else
        {
    ...
    {
        return $this->db->query("SELECT * FROM $this->table WHERE code = '$value'");
    }
